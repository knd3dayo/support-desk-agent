# analyze_office_urls ツール下書き

このファイルは ToolRegistry から半自動生成した下書きです。

## 概要
- description: Analyze Office URLs

## 利用エージェント
- SuperVisorAgent: provider=builtin, target=analyze_office_urls, status=implemented, override=allowed
- ObjectiveEvaluator: provider=builtin, target=analyze_office_urls, status=implemented, override=allowed
