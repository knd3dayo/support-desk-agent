# BackSupportInquiryWriterAgent ツール下書き
...
- write_draft: Write escalation inquiry draft (provider=builtin, target=default-draft-writer, status=implemented, override=allowed)
