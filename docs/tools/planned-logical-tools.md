...
- 実装着手時は [src/support_desk_agent/tools/registry.py](/home/user/source/repos/support-ope-agents/src/support_desk_agent/tools/registry.py) の placeholder を builtin または orchestration 実装へ置き換える
- config 変更が必要なものは [src/support_desk_agent/config/tool_surface.py](/home/user/source/repos/support-ope-agents/src/support_desk_agent/config/tool_surface.py) も合わせて見直す
