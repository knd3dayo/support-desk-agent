...
- 既定では未接続で、MCP override または [config.yml](/home/user/source/repos/support-ope-agents/config.yml) の intake.internal_ticket で構成する
...
- IntakeAgent は保存した添付を .artifacts/intake/ 配下に置き、KnowledgeRetrieverAgent と LogAnalyzerAgent が優先参照する
