...
- 既定実装: [src/support_desk_agent/tools/default_read_shared_memory.py](/home/user/source/repos/support-ope-agents/src/support_desk_agent/tools/default_read_shared_memory.py)
