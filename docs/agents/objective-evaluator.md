...
- agent 定義メタデータは [src/support_ope_agents/agents/objective_evaluator.py](/home/user/source/repos/support-ope-agents/src/support_ope_agents/agents/objective_evaluator.py) に置く
...
- instruction は [src/support_ope_agents/instructions/defaults/ObjectiveEvaluator.md](/home/user/source/repos/support-ope-agents/src/support_ope_agents/instructions/defaults/ObjectiveEvaluator.md) を既定とし、必要に応じて override 可能とする