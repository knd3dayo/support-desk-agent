...
- SuperVisorAgent: inspect_workflow_state, evaluate_agent_result, route_phase_agent, read_shared_memory, scan_workspace_artifacts, spawn_log_analyzer_agent, spawn_knowledge_retriever_agent, spawn_draft_writer_agent, spawn_compliance_reviewer_agent
