...
本設計書は、support-ope-agents における現行のカスタマーサポート業務シナリオ実装方針をまとめる。
...
- tool の詳細仕様は [docs/tools/README.md](/home/user/source/repos/support-ope-agents/docs/tools/README.md) を参照する
