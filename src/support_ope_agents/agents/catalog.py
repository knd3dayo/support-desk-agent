...
from support_ope_agents.agents.objective_evaluation_agent import build_objective_evaluation_agent_definition
...
def build_default_agent_definitions() -> list[AgentDefinition]:
    return [
        ...
        build_objective_evaluation_agent_definition(),
