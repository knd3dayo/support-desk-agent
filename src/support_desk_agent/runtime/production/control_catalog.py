...
def _load_common_instruction_text(config: AppConfig) -> str:
    default_root = files("support_desk_agent.instructions.defaults")
    parts: list[str] = []
...
def _build_control_points(config: AppConfig, instructions: dict[str, object]) -> list[dict[str, object]]:
    ...
    control_points = [
        _control_point(
            ...
            code_refs=["src/support_desk_agent/config/models.py", "src/support_desk_agent/workflow/case_workflow.py"],
        ),
        _control_point(
            ...
            docs_refs=["docs/configuration.md", "docs/customer-support-deepagents-design.md"],
            code_refs=["src/support_desk_agent/config/models.py"],
        ),
        _control_point(
        ...
        _control_point(
            ...
            code_refs=["src/support_desk_agent/config/models.py", "src/support_desk_agent/agents/supervisor_agent.py"],
        ),
        _control_point(
            control_point_id="instruction.default_stack",
            category="instruction",
            owner="all-agents",
            origin="support_desk_agent.instructions.defaults",
            ...
            code_refs=["src/support_desk_agent/instructions/loader.py", "src/support_desk_agent/instructions/defaults/common.md"],
        ),
        _control_point(
            ...
            docs_refs=["docs/configuration.md", "docs/agents/supervisor-agent.md"],
            code_refs=["src/support_desk_agent/instructions/loader.py"],
        ),
        _control_point(
            ...
            code_refs=["src/support_desk_agent/workflow/case_workflow.py"],
        ),
        _control_point(
            ...
            code_refs=["src/support_desk_agent/workflow/case_workflow.py", "src/support_desk_agent/agents/supervisor_agent.py"],
        ),
        _control_point(
    ...
    for role_entry in _instruction_role_entries(instructions):
        control_points.append(
            _control_point(
                ...
                code_refs=[str(role_entry["default_path"]), "src/support_desk_agent/instructions/loader.py"],
            )
        )
